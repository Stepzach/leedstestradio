 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */oi(sA,oA,"app");const aA={apiKey:"AIzaSyCBFpZV-UFODiRIbS6BMRmhDI-7nWn85VI",authDomain:"mychatapp-56623.firebaseapp.com",projectId:"mychatapp-56623",storageBucket:"mychatapp-56623.firebasestorage.app",messagingSenderId:"183438867440",appId:"1:183438867440:web:9c96843122e778cc917b35",measurementId:"G-K1MBVJ8XB3"},Y_=Qg(aA),jh=zT(Y_),zg=MS(Y_);function lA(){const[i,e]=Zr.useState(null),[t,s]=Zr.useState([]),[o,u]=Zr.useState(""),h=Zr.useRef(null);Zr.useEffect(()=>{const v=KS(Lg(zg,"messages"),QS("timestamp"));return tA(v,C=>{s(C.docs.map(F=>({id:F.id,data:F.data()})))})},[]),Zr.useEffect(()=>{h.current&&h.current.scrollIntoView({behavior:"smooth"})},[t]),Zr.useEffect(()=>kw(jh,w=>{e(w||null)}),[]);const m=async()=>{o.trim()!==""&&(await eA(Lg(zg,"messages"),{uid:i.uid,photoURL:i.photoURL,displayName:i.displayName,text:o,timestamp:iA()}),u(""))},y=async()=>{const v=new gr;try{await Qw(jh,v)}catch(w){console.error("Google login error:",w)}};return vt.jsx("div",{className:"app-container",children:i?vt.jsxs("div",{className:"chat-wrapper",children:[vt.jsxs("div",{className:"user-info",children:["Logged in as .",vt.jsx("span",{className:"user-name",children:i.displayName})]}),vt.jsxs("div",{className:"message-input",children:[vt.jsx("input",{type:"text",placeholder:"Type a message...",value:o,onChange:v=>u(v.target.value),className:"input-box"}),vt.jsx("button",{onClick:m,className:"send-button",children:"Send Message"})]}),vt.jsx("button",{onClick:()=>jh.signOut(),className:"logout-button",children:"Logout"}),vt.jsxs("div",{className:"messages-container",children:[t.map(v=>vt.jsxs("div",{className:"message-item",children:[vt.jsx("img",{src:v.data.photoURL,alt:`${v.data.displayName}'s profile`,className:"message-avatar"}),vt.jsxs("div",{className:"message-content",children:[vt.jsx("span",{className:"message-author",children:v.data.displayName}),vt.jsx("p",{className:"message-text",children:v.data.text})]})]},v.id)),vt.jsx("div",{ref:h})," "]})]}):vt.jsx("button",{onClick:y,className:"login-button",children:"Login with Google"})})}u0.createRoot(document.getElementById("root")).render(vt.jsx(Zr.StrictMode,{children:vt.jsx(lA,{})}));
